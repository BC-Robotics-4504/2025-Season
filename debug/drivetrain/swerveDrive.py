...
class SwerveDrive:
    ...
    def move(self, Lx: float, Ly: float, Rx: float):
        ...
        Vx0 = (
            -Lx
            * self.RobotConfig.max_driving_speed
            * self.RobotConfig.drive_wheel_diameter
            * math.pi
        )
        Vy0 = (
            Ly
        ...
        self.__frontLeftSpeed__ = math.hypot(Vyp, Vxp) / (
            math.pi * self.RobotConfig.drive_wheel_diameter
        )
    ...
    def normalizeSpeeds(self):
        ...
        maxSpeed = max(
            [
                self.__frontLeftSpeed__,
                self.__frontRightSpeed__,
                self.__rearLeftSpeed__,
                self.__rearRightSpeed__,
            ]
        )
    ...
    def execute(self):
        ...
        """
        print(self.__frontLeftAngle__, self.__frontRightAngle__, self.__rearLeftAngle__, self.__rearRightAngle__)
